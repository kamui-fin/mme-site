...
const Terms: NextPage = () => {
    return (
        <div className={styles.page}>
            ...
            <p>
                These terms and conditions outline the rules and regulations for the use of MONOGATARI MEDIA EDITORIAL's
                Website, located at https://monogataried.com/.
            </p>

            <p>
                By accessing this website we assume you accept these terms and conditions. Do not continue to use MONOGATARI
                MEDIA if you do not agree to take all of the terms and conditions stated on this page.
            </p>
            ...
            <p>
                We employ the use of cookies. By accessing MONOGATARI MEDIA, you agreed to use cookies in agreement with the
                MONOGATARI MEDIA EDITORIAL's Privacy Policy.{" "}
            </p>
            ...
            <p>
                Unless otherwise stated, MONOGATARI MEDIA EDITORIAL and/or its licensors own the intellectual property rights
                for all material on MONOGATARI MEDIA. All intellectual property rights are reserved. You may access this from
                MONOGATARI MEDIA for your own personal use subjected to restrictions set in these terms and conditions.
            </p>
            ...
            <p>
                ...
                areas of the website. MONOGATARI MEDIA EDITORIAL does not filter, edit, publish or review Comments prior to
                their presence on the website. Comments do not reflect the views and opinions of MONOGATARI MEDIA
                EDITORIAL,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their
                views and opinions. To the extent permitted by applicable laws, MONOGATARI MEDIA EDITORIAL shall not be
            ...
            <p>
                MONOGATARI MEDIA EDITORIAL reserves the right to monitor all Comments and to remove any Comments which can be
            ...
            <p>
                You hereby grant MONOGATARI MEDIA EDITORIAL a non-exclusive license to use, reproduce, edit and authorize
            ...
            <p>
                ...
                MONOGATARI MEDIA EDITORIAL; and (d) the link is in the context of general resource information.
            </p>
            ...
            <p>
                ...
                you must inform us by sending an e-mail to MONOGATARI MEDIA EDITORIAL. Please include your name, your
            ...
            <p>
                No use of MONOGATARI MEDIA EDITORIAL's logo or other artwork will be allowed for linking absent a trademark
                license agreement.
            </p>
