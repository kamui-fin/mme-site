...
const Privacy: NextPage = () => {
    return (
        <div className={styles.page}>
            <Head>
                <title>MME | Privacy</title>
            </Head>
            <h1>Privacy Policy for MONOGATARI MEDIA EDITORIAL</h1>

            <p>
                At MONOGATARI MEDIA, accessible from https://monogataried.com/, one of our main priorities is the privacy of
                our visitors. This Privacy Policy document contains types of information that is collected and recorded by
                MONOGATARI MEDIA and how we use it.
            </p>
            ...
            <p>
                ...
                regards to the information that they shared and/or collect in MONOGATARI MEDIA. This policy is not applicable
            ...
            <p>
                MONOGATARI MEDIA follows a standard procedure of using log files. These files log visitors when they visit
            ...
            <p>
                You may consult this list to find the Privacy Policy for each of the advertising partners of MONOGATARI
                MEDIA.
            </p>

            <p>
                Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in their respective advertisements and links that appear on MONOGATARI MEDIA, which are sent directly to
            ...
            <p>
                Note that MONOGATARI MEDIA has no access to or control over these cookies that are used by third-party
                advertisers.
            </p>
            ...
            <p>
                MONOGATARI MEDIA's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you
            ...
            <p>
                MONOGATARI MEDIA does not knowingly collect any Personal Identifiable Information from children under the age
