    ...
    const mobileColumn = () => {
        return (
            <aside className={styles.filterMobile} style={{display: toggle ? "flex" : "none"}}>
                <button className={styles.close} onClick={() => applyFilters()}><Image src="/close.png" width={48} height={48}/></button>
        ...
        <div className={styles.store}>
            ...
            <BreadCrumbs path={[{name: "Home", href: "/"}, {name: "Store", href: "/products"}]}/>
                ...
                <div className={styles.searchSort}>
                    ...
                    <button className={cx(button.btn, button.secondary, styles.button)} onClick={() => setToggle(!toggle)}>Sort Filter</button>
                </div>
